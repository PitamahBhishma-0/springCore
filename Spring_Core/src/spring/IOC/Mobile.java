...
public class Mobile {
	...
	public static void main(String[] args) {
		/*  
		 * CLASS REFRENCE------------------- BAD METHOD
		NTC ntc=new NTC();
		ntc.calling();
		*/
		/*
		 * INTERFENCE REFRENCE---------------------GOOD SOFTWARE_ENGINERING PRACTICE
		Sim ntc=new NTC();
	    ntc.calling();
         */
...
/*
 * WHILE USING CLASS REFERENCE METHOD WE HAVE TO CHANGE THE CODE IF WE WANT TO USE ANOTHER SIM SERVICE PROVIDER AND CONFIGURE THE 
 * CONFIGURATIONFILE(bean.xml) which is against the spring.
 *BUT IF WE USE THE INTERFACE APPROACH, CALLING THE BEAN WE HAVE TO CHANGE ONLY THE CONFIG FILE IF WE WANT TO ADD  OTHER SERVICE PROVIDER
 */
